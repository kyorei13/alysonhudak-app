...
public class DatabaseUtils {
    ...
    // If this were in a real program  then these values would be a configurable property and not hard coded.
    // JDBC driver name and database URL
    private static final String JDBC_DRIVER = "com.mysql.jdbc.Driver";
    private static final String DB_URL = "jdbc:mysql://localhost:3306/stocks";

    //  Database credentials for login
    private static final String USER = "Smarks";
    private static final String PASS = "java_class";
    ...
    public static Connection getConnection() throws DatabaseConnectionException{
        ...
        try {
            ...
            throw new  DatabaseConnectionException("Could not establish connection to database." + e.getMessage(), e);
        }
        return connection;
    }

    /**
     * A utility method that runs a database initializationscript.
