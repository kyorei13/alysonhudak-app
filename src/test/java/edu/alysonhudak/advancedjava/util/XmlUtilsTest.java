...
import edu.alysonhudak.advancedjava.util.XMLUtils;
...
public class XmlUtilsTest {
    ...
    public void testMarshal() throws Exception {
        ...
        assertEquals("TheXML out is correct", xml.trim(), xmlStocks.trim());
    }

    private void validateStocks(Stocks stocks) {
        assertTrue("The stock symbol is correct", stocks.getStock().get(0).getSymbol().equals(STOCK_SYMBOL_INDEX0));
    }
}